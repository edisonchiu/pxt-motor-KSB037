...
namespace motor-KSB037 {
    /**
    * 左右馬達同時正轉
    */
    //% blockId="forward" block="car forward|speed(0~1023) %power"
    //% blockGap=1 weight=90
    //% power.min=0 power.max=1023
    export function forward(power: number) {
    ...
    */
    ...
    //% blockId="leftMotor_forward" block="left motor forward|speed(0~1023) %power"
    //% blockGap=1  weight=30
    //% power.min=0 power.max=1023
    export function leftMotor_forward(power: number) {
        pins.digitalWritePin(DigitalPin.P12, 1)
        pins.analogWritePin(AnalogPin.P2, power)
    }
    ...
    //% blockId="rightMotor_forward" block="right motor forward|speed(0~1023) %power"
    //% blockGap=1  weight=50
    //% power.min=0 power.max=1023
    export function rightMotor_forward(power: number) {
        pins.digitalWritePin(DigitalPin.P8, 1)
        pins.analogWritePin(AnalogPin.P1, power)
    }
